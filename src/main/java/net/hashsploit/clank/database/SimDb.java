...
public class SimDb implements IDatabase {
	...
	private class SimDbPlayer {
		...
		private String ladderStatsWide;
		...
		public String getLadderStatsWide() {
			return ladderStatsWide;
		}

		public void setLadderStatsWide(String ladderStatsWide) {
			this.ladderStatsWide = ladderStatsWide;
		}
	...
	public String getLadderStatsWide(int accountId) {
		...
		String res = p.getLadderStatsWide();
		if (res == null) {
			return "";
		}
		return res;
