...
import net.hashsploit.clank.server.medius.packets.serializers.ServerAuthenticationRequest;
import net.hashsploit.clank.server.medius.packets.serializers.ServerAuthenticationResponse;
