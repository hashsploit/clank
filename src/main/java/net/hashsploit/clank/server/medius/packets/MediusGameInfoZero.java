...
public class MediusGameInfoZero extends MediusPacket {
	...
	public MediusMessage write(MediusClient client) {
		...
		try {
			...
			outputStream.write(Utils.hexStringToByteArray("03000000")); // playerSkillLevel -- SETTING THIS TO 01000000 TURNS FLUX OFF
			...
			outputStream.write(Utils.buildByteArrayFromString("hashsploit's", MediusConstants.GAMENAME_MAXLEN.getValue()));
