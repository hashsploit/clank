...
public class MlsHandler extends MessageToMessageDecoder<ByteBuf> {

	private static final Logger logger = Logger.getLogger(MlsHandler.class.getName());
	private final MediusClient client;

	public MlsHandler(final MediusClient client) {
		super();
		this.client = client;
	}
