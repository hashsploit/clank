...
public class CheckMyClanInvitationsResponse extends MediusMessage {
	...
	public byte[] getPayload() {
		...
		try {
			...
			outputStream.write(Utils.buildByteArrayFromString(message, MediusConstants.CLANMSG_MAXLEN.value));
			outputStream.write(Utils.intToBytesLittle(leaderAccountId));
			outputStream.write(Utils.buildByteArrayFromString(leaderAccountName, MediusConstants.ACCOUNTNAME_MAXLEN.value));
